...
<body class="bg-gray-50 min-h-screen p-8 antialiased">
    ...
    <div class="max-w-4xl mx-auto mb-8 flex justify-between items-center bg-white p-4 rounded-3xl border border-gray-200 shadow-sm no-print">
    ...
    <div class="max-w-4xl mx-auto bg-white p-10 rounded-[2.5rem] border border-gray-200 shadow-sm print-card">
        <!-- Logo & Header -->
        ...
        <div class="border border-gray-200 rounded-3xl overflow-hidden mb-10">
